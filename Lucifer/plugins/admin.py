...
from Lucifer.utils import admin_cmd, errors_handler, sudo_cmd
...
@Lucifer.on(admin_cmd(outgoing=True, pattern="setgpic"))
@Lucifer.on(sudo_cmd(outgoing=True, pattern="setgpic", allow_sudo=True))
@errors_handler
...
@Lucifer.on(admin_cmd("promote(?: |$)(.*)"))
@Lucifer.on(sudo_cmd(pattern="promote(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@Lucifer.on(admin_cmd(outgoing=True, pattern="demote(?: |$)(.*)"))
@Lucifer.on(sudo_cmd(pattern="demote(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@Lucifer.on(admin_cmd(pattern="(ban|unban) ?(.*)"))
@Lucifer.on(sudo_cmd(pattern="(ban|unban) ?(.*)", allow_sudo=True))
async def _(event):
...
@Lucifer.on(admin_cmd(pattern="pgs ?(.*)"))
@Lucifer.on(sudo_cmd(pattern="pgs ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lucifer.on(admin_cmd(outgoing=True, pattern="admins$"))
@errors_handler
...
@Lucifer.on(admin_cmd(outgoing=True, pattern="pin(?: |$)(.*)"))
@Lucifer.on(sudo_cmd(outgoing=True, pattern="pin(?: |$)(.*)"))
@errors_handler
async def pin(msg):
...
@Lucifer.on(admin_cmd(outgoing=True, pattern="kick(?: |$)(.*)"))
@Lucifer.on(sudo_cmd(outgoing=True, pattern="kick(?: |$)(.*)", allow_sudo=True))
@errors_handler
async def kick(usr):
...
@Lucifer.on(admin_cmd(outgoing=True, pattern="users ?(.*)"))
@errors_handler
