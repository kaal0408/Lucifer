...
@Lucifer.on(admin_cmd(outgoing=True, pattern=r"gmute ?(\d+)?"))
@Lucifer.on(sudo_cmd(allow_sudo=True, pattern=r"gmute ?(\d+)?"))
...
@Lucifer.on(admin_cmd(outgoing=True, pattern=r"ungmute ?(\d+)?"))
@Lucifer.on(sudo_cmd(allow_sudo=True, pattern=r"ungmute ?(\d+)?"))
