...
from Lucifer.plugins.sql_helper.snips_sql import (
    add_snip,
    get_all_snips,
    get_snips,
    remove_snip,
...
@Lucifer.on(events.NewMessage(pattern=r"\#(\S+)", outgoing=True))
...
@Lucifer.on(admin_cmd(pattern="snips (.*)"))
...
@Lucifer.on(admin_cmd(pattern="snipl"))
...
@Lucifer.on(admin_cmd(pattern=r"snipd (\S+)"))
