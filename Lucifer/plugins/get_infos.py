...
@Lucifer.on(admin_cmd(pattern="get_ad?(m)in ?(.*)"))
@Lucifer.on(sudo_cmd(pattern="get_ad?(m)in ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lucifer.on(admin_cmd(pattern="get_id"))
@Lucifer.on(sudo_cmd(pattern="get_id", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if event.reply_to_msg_id:
...
@Lucifer.on(admin_cmd(pattern="get_bot ?(.*)"))
@Lucifer.on(sudo_cmd(pattern="get_bot ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
