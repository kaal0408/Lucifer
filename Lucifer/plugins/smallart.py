...
@Lucifer.on(admin_cmd(pattern="sthink (.*)"))
...
@Lucifer.on(admin_cmd(pattern="sdick (.*)"))
...
@Lucifer.on(admin_cmd(pattern="sfrog (.*)"))
...
@Lucifer.on(admin_cmd(pattern="sputin (.*)"))
...
@Lucifer.on(admin_cmd(pattern="sdead (.*)"))
...
@Lucifer.on(admin_cmd(pattern="strump (.*)"))
...
@Lucifer.on(admin_cmd(pattern="schina (.*)"))
...
@Lucifer.on(admin_cmd(pattern=r"spika"))
async def kakashi(pikachu):
    await pikachu.edit(F)


@Lucifer.on(admin_cmd(pattern=r"sshit"))
async def kakashi(shit):
    await shit.edit(G)


@Lucifer.on(admin_cmd(pattern=r"sxx"))
async def kakashi(saxy):
    await saxy.edit(H)


@Lucifer.on(admin_cmd(pattern=r"sporn"))
