...
@Lucifer.on(admin_cmd(pattern="mslap ?(.*)"))
@Lucifer.on(sudo_cmd(pattern="mslap ?(.*)", allow_sudo=True))
async def who(event):
    if event.fwd_from:
        return
...
@Lucifer.on(admin_cmd(outgoing=True, pattern="mrape"))
@Lucifer.on(sudo_cmd(allow_sudo=True, pattern="mrape"))
...
@Lucifer.on(admin_cmd(outgoing=True, pattern="mshe"))
@Lucifer.on(sudo_cmd(allow_sudo=True, pattern="mshe"))
...
@Lucifer.on(admin_cmd(outgoing=True, pattern="mabuse"))
@Lucifer.on(sudo_cmd(allow_sudo=True, pattern="mabuse"))
...
@Lucifer.on(admin_cmd(outgoing=True, pattern="mruns"))
@Lucifer.on(sudo_cmd(allow_sudo=True, pattern="mruns"))
async def fuckedd(abusehard):
...
@Lucifer.on(admin_cmd(outgoing=True, pattern="minsult$"))
@Lucifer.on(sudo_cmd(allow_sudo=True, pattern="minsult$"))
async def proo(pros):
...
@Lucifer.on(admin_cmd(pattern=r"foryou$", outgoing=True))
@Lucifer.on(sudo_cmd(pattern=r"foryou$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lucifer.on(admin_cmd(outgoing=True, pattern="kozhi"))
@Lucifer.on(sudo_cmd(allow_sudo=True, pattern="kozhi"))
