...
telegraph = Telegraph()
mee = telegraph.create_account(short_name="Lucifer")


@Lucifer.on(admin_cmd(pattern="purl ?(.*)"))
@Lucifer.on(sudo_cmd(pattern="purl ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lucifer.on(admin_cmd(pattern="reader ?(.*)"))
@Lucifer.on(sudo_cmd(pattern="reader ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@Lucifer.on(admin_cmd(pattern="aud ?(.*)"))
@Lucifer.on(sudo_cmd(pattern="aud ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@Lucifer.on(admin_cmd(pattern="instadl ?(.*)"))
@Lucifer.on(sudo_cmd(pattern="instadl ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@Lucifer.on(admin_cmd(pattern="stats$"))
@Lucifer.on(sudo_cmd(pattern="stats$", allow_sudo=True))
...
@Lucifer.on(admin_cmd(pattern="xogame$"))
@Lucifer.on(sudo_cmd(pattern="xogame$", allow_sudo=True))
...
@Lucifer.on(admin_cmd(pattern="whisper ?(.*)"))
@Lucifer.on(sudo_cmd(pattern="whisper ?(.*)", allow_sudo=True))
...
@Lucifer.on(admin_cmd(pattern="crack ?(.*)"))
@Lucifer.on(sudo_cmd(pattern="crack ?(.*)", allow_sudo=True))
async def mod(event):
    if event.fwd_from:
        return
...
@Lucifer.on(admin_cmd(pattern="checkspam ?(.*)"))
@Lucifer.on(sudo_cmd(pattern="checkspam ?(.*), allow_sudo=True"))
async def _(event):
    bot = "@SpamBot"
    if event.fwd_from:
        return
...
@Lucifer.on(admin_cmd(pattern="gitdl ?(.*)"))
@Lucifer.on(sudo_cmd(pattern="gitdl ?(.*), allow_sudo=True"))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@Lucifer.on(admin_cmd(pattern="imusic ?(.*)"))
@Lucifer.on(sudo_cmd(pattern="imusic ?(.*)", allow_sudo=True))
async def tel(event):
    if event.fwd_from:
        return
...
@Lucifer.on(admin_cmd(pattern="font ?(.*)"))
@Lucifer.on(sudo_cmd(pattern="font ?(.*)", allow_sudo=True))
async def _(event):
    bot = "@fontsgenbot"
    if event.fwd_from:
        return
