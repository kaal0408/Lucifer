...
import Lucifer.plugins.sql_helper.blacklist_sql as sql
...
@Lucifer.on(admin_cmd(pattern="addblacklist ((.|\n)*)"))
@Lucifer.on(sudo_cmd(pattern="addblacklist ((.|\n)*)"))
...
@Lucifer.on(admin_cmd(pattern="listblacklist"))
@Lucifer.on(sudo_cmd(pattern="listblacklist"))
...
@Lucifer.on(admin_cmd(pattern="rmblacklist ((.|\n)*)"))
@Lucifer.on(sudo_cmd(pattern="rmblacklist ((.|\n)*)"))
