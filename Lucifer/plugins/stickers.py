...
lucifername = Var.CUSTOM_STICKER_PACK_NAME


@Lucifer.on(admin_cmd(outgoing=True, pattern="kang"))
@Lucifer.on(sudo_cmd(pattern="kang", allow_sudo=True))
async def kang(args):
...
@Lucifer.on(admin_cmd(outgoing=True, pattern="stkrinfo"))
@Lucifer.on(sudo_cmd(pattern="stkrinfo", allow_sudo=True))
