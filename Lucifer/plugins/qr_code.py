...
@Lucifer.on(admin_cmd(pattern="getqr"))
@Lucifer.on(sudo_cmd(pattern="getqr", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
...
@Lucifer.on(admin_cmd(pattern="makeqr ?(.*)"))
@Lucifer.on(sudo_cmd(pattern="makeqr ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
