...
from Lucifer.plugins.sql_helper.filter_sql import (
    add_filter,
    get_all_filters,
    remove_all_filters,
    remove_filter,
...
@Lucifer.on(admin_cmd(pattern="savefilter (.*)"))
@Lucifer.on(sudo_cmd(pattern="savefilter (.*)", allow_sudo=True))
...
@Lucifer.on(admin_cmd(pattern="listfilters"))
@Lucifer.on(sudo_cmd(pattern="listfilters", allow_sudo=True))
...
@Lucifer.on(admin_cmd(pattern="clearfilter (.*)"))
@Lucifer.on(sudo_cmd(pattern="clearfilter (.*)", allow_sudo=True))
...
@Lucifer.on(admin_cmd(pattern="clearallfilters"))
@Lucifer.on(sudo_cmd(pattern="clearallfilters", allow_sudo=True))
