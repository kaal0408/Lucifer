...
@Lucifer.on(admin_cmd(pattern="repcf", outgoing=True))
@Lucifer.on(sudo_cmd(pattern="repcf", allow_sudo=True))
...
@Lucifer.on(admin_cmd(pattern="addcf", outgoing=True))
@Lucifer.on(sudo_cmd(pattern="addcf", allow_sudo=True))
...
@Lucifer.on(admin_cmd(pattern="remcf", outgoing=True))
@Lucifer.on(sudo_cmd(pattern="remcf", allow_sudo=True))
