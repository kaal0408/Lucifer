...
@Lucifer.on(sudo_cmd(pattern="warn1", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mentions = (
...
@Lucifer.on(admin_cmd(pattern="warn2"))
@Lucifer.on(sudo_cmd(pattern="warn2", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lucifer.on(admin_cmd(pattern="warn3"))
@Lucifer.on(admin_cmd(pattern="warn3", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mentions = (
...
@Lucifer.on(admin_cmd(pattern="warn0"))
@Lucifer.on(admin_cmd(pattern="warn0", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lucifer.on(admin_cmd(pattern="ocb"))
@Lucifer.on(sudo_cmd(pattern="ocb", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lucifer.on(admin_cmd(pattern="fw"))
async def _(event):
    if event.fwd_from:
        return
