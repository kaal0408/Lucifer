...
@Lucifer.on(admin_cmd(outgoing=True, pattern="lyrics ?(.*)"))
@Lucifer.on(sudo_cmd(allow_sudo=True, pattern="lyrics ?(.*)"))
async def _(event):
...
@Lucifer.on(admin_cmd(outgoing=True, pattern="glyrics ?(.*)"))
@Lucifer.on(sudo_cmd(outgoing=True, pattern="glyrics ?(.*)", allow_sudo=True))
