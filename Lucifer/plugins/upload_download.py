...
from Lucifer import CMD_HELP, LOGS, TEMP_DOWNLOAD_DIRECTORY
...
@Lucifer.on(admin_cmd(pattern=r"dl(?: |)(.*)", outgoing=True))
@Lucifer.on(sudo_cmd(pattern=r"dl(?: |)(.*)", allow_sudo=True))
...
@Lucifer.on(admin_cmd(pattern=r"uploadir (.*)", outgoing=True))
@Lucifer.on(sudo_cmd(pattern=r"uploadir (.*)", allow_sudo=True))
...
@Lucifer.on(admin_cmd(pattern=r"ul (.*)", outgoing=True))
@Lucifer.on(sudo_cmd(pattern=r"ul (.*)", allow_sudo=True))
...
@Lucifer.on(admin_cmd(pattern=r"uploadas(stream|vn|all) (.*)", outgoing=True))
@Lucifer.on(sudo_cmd(pattern=r"uploadas(stream|vn|all) (.*)", allow_sudo=True))
