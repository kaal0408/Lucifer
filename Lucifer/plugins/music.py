...
@Lucifer.on(admin_cmd(outgoing=True, pattern="spd(?: |$)(.*)"))
@Lucifer.on(sudo_cmd(allow_sudo=True, pattern="spd(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    ...
    async with bot.conversation(chat) as conv:
        ...
        await msg.edit(
            f"Song name - __{link}__\nUploaded by [Lucifer](https://t.me/Lucifer_support_group)"
        )


@Lucifer.on(admin_cmd(outgoing=True, pattern="netease(?: |$)(.*)"))
@Lucifer.on(sudo_cmd(allow_sudo=True, pattern="netease(?: |$)(.*)"))
...
@Lucifer.on(admin_cmd(outgoing=True, pattern="dzd(?: |$)(.*)"))
@Lucifer.on(sudo_cmd(allow_sudo=True, pattern="dzd(?: |$)(.*)"))
