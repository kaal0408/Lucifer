...
from Lucifer.plugins.sql_helper.mute_sql import is_muted, mute, unmute
from Lucifer.utils import admin_cmd


@Lucifer.on(admin_cmd(outgoing=True, pattern=r"mute ?(\d+)?"))
@Lucifer.on(sudo_cmd(allow_sudo=True, pattern=r"mute ?(\d+)?"))
...
@Lucifer.on(admin_cmd(outgoing=True, pattern=r"unmute ?(\d+)?"))
@Lucifer.on(sudo_cmd(allow_sudo=True, pattern=r"unmute ?(\d+)?"))
...
@Lucifer.on(admin_cmd(incoming=True))
